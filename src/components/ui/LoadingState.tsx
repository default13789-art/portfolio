...
const LoadingState = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#050510]">
      ...
      {/* Pulsing Orbs */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-[#00F5FF] rounded-full blur-[100px] opacity-30 animate-pulse" />
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-[#8A2BE2] rounded-full blur-[120px] opacity-30 animate-pulse" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#00F5FF] rounded-full blur-[150px] opacity-20 animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 w-full max-w-2xl px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-block relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="w-32 h-32 border-2 border-[#00F5FF]/30 rounded-full animate-spin"
                style={{ animationDuration: '3s' }}
              />
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="w-24 h-24 border-2 border-[#8A2BE2]/30 rounded-full animate-spin"
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 px-6 py-3 glass-card rounded-lg">
            <span className="text-[#00F5FF] font-mono text-sm">&gt;</span>
        ...
        <div className="relative">
          {/* Outer Glow */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#00F5FF]/20 to-[#8A2BE2]/20 rounded-lg blur-lg" />
          ...
          <div className="relative glass-card rounded-lg p-6">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-[#00F5FF] font-mono text-lg font-bold">{Math.round(progress)}%</span>
            </div>
            ...
            <div className="relative h-2 bg-gray-800/50 rounded-full overflow-hidden">
              ...
              {/* Progress Fill */}
              <div
                className="relative h-full bg-gradient-to-r from-[#00F5FF] via-[#00F5FF] to-[#8A2BE2] rounded-full transition-all duration-100 ease-out"
            ...
            <div key={i} className="glass-card rounded-lg p-4">
              ...
              <div className="h-16 flex items-end justify-between gap-1">
                {[...Array(8)].map((_, j) => (
                  <div
                    key={j}
                    className="flex-1 bg-gradient-to-t from-[#00F5FF] to-[#8A2BE2] rounded-sm transition-all duration-300"
                    style={{
