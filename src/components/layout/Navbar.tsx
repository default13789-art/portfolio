  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-[#050510]/80 backdrop-blur-lg border-b border-white/10 shadow-lg'
          : 'bg-transparent'
      }`}
    >
      <div className="section-container">
            ...
            >
              <defs>
                ...
                <filter id="icon-shadow" x="-20%" y="-20%" width="140%" height="140%">
                  <feDropShadow dx="0" dy="0" stdDeviation="3" floodColor="#00F5FF" floodOpacity="0.35" />
                </filter>
              </defs>
              ...
              <g filter="url(#icon-shadow)">
                ...
                {/* Signal 1: A → E */}
                <circle r="1.5" fill="#00F5FF" filter="url(#sig-glow)">
                ...
                {/* Signal 3: E → G */}
                <circle r="1.5" fill="#8A2BE2" filter="url(#sig-glow)">
                ...
                {/* Signal 4: C → F */}
                <circle r="1.2" fill="#00F5FF" filter="url(#sig-glow)">
        ...
        {isMobileMenuOpen && (
          <div
            className="md:hidden fixed inset-0 top-16 bg-[#050510]/95 backdrop-blur-xl animate-fade-in"
            role="dialog"
            aria-modal="true"
