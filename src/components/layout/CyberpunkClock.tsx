  ...
  return (
    ...
    >
      ...
      <div className="relative group cursor-pointer transition-all duration-300">
        {/* Clock Display */}
        <div className="relative bg-gradient-to-br from-[#050510] to-[#050510] border border-cyan-500/30 rounded-lg p-3 overflow-hidden shadow-lg shadow-cyan-500/10">
          {/* Scanline Effect */}
      ...
      <div className="flex gap-1">
        ...
        <div
          className="w-1 h-1 rounded-full animate-pulse"
          style={{ backgroundColor: '#8A2BE2', animationDelay: '0.2s' }}
        ></div>
        <div
          className="w-1 h-1 rounded-full animate-pulse"
