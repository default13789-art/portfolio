    ...
    <div className="flex flex-col items-center justify-center py-10 text-center space-y-5 animate-fade-in-up">
      ...
      <button
        ...
        className="mt-2 px-6 py-2.5 rounded-lg text-sm font-semibold border transition-all duration-300
          border-gray-600 text-gray-300 hover:border-sapphire-blue hover:text-sapphire-blue"
      >
...
const Contact = () => {
  ...
  // Enable 3D loading when component mounts
  useEffect(() => {
    setCanLoad3D(true);
  }, []);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="group relative">
                ...
                <Card className="relative hover:transform hover:-translate-y-1 transition-transform duration-300 hover:border-[#d4af37]/30 backdrop-blur-xl bg-white/[0.03] border-white/10 shadow-[0_0_40px_rgba(212,175,55,0.15)]">
                  <CardContent className="p-6 flex items-start">
                    <div className="w-12 h-12 bg-gradient-to-br from-gold-luster/20 to-sapphire-blue/20 rounded-lg flex items-center justify-center mr-4 flex-shrink-0 group-hover:scale-110 transition-transform duration-300 border border-gold-luster/30 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
          ...
          <div className={`reveal reveal-fade-in-right reveal-stagger-2 ${isVisible ? 'reveal-active' : ''}`}>
            <div className="relative">
              {/* 3D Universe Background - positioned behind the contact form */}
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-[#d4af37]/20 via-[#3ce6f9]/20 to-[#a855f7]/20 rounded-2xl blur-xl opacity-30" />
              <Card className="relative hover:border-[#d4af37]/30 transition-all duration-300 bg-[#0a0a0f]/60 backdrop-blur-xl border-white/10 shadow-[0_0_40px_rgba(212,175,55,0.15)]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                        ...
                        >
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 bg-[#1a1a24]/80 backdrop-blur-xl border rounded-lg text-white placeholder-gray-500 outline-none transition-all duration-300 ${
                      ...
                      <div className="reveal reveal-fade-in-up reveal-stagger-6 relative">
                        ...
                        <div className="relative">
                          ...
                          <textarea
                            ...
                            aria-label="Message"
                            className={`w-full px-4 py-3 bg-[#1a1a24]/80 backdrop-blur-xl border rounded-lg text-white placeholder-gray-500 outline-none transition-all duration-300 resize-none ${
                      ...
                      <div className="reveal reveal-fade-in-up reveal-stagger-7">
                        <button
                          ...
                          className="group relative w-full overflow-hidden rounded-lg bg-gradient-to-r from-[#d4af37]/30 via-[#3ce6f9]/30 to-[#a855f7]/30 p-0.5 transition-all duration-300 hover:shadow-[0_0_40px_rgba(212,175,55,0.4)] disabled:opacity-60 disabled:cursor-not-allowed"
                        >
