...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-b from-transparent via-[#050510]/30 to-[#050510] pointer-events-none z-0"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 section-container">
        <div className="max-w-4xl mx-auto">
          {/* Glassmorphism Card wrapped in AnimatedSection */}
          <AnimatedSection direction="up" delay={0.2}>
            <div className="glass-card p-6 sm:p-8 md:p-12 lg:p-16 text-center backdrop-blur-xl bg-white/[0.03] border border-white/10 shadow-[0_0_40px_rgba(212,175,55,0.15)] mx-2 sm:mx-0">
              ...
              <h1
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl gradient-text neon-text-gradient neon-pulse mb-4 sm:mb-6 font-black px-2 opacity-100"
                style={{
              ...
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gray-200 mb-4 sm:mb-6 min-h-[48px] sm:min-h-[60px] md:min-h-[72px] flex items-center justify-center px-2 opacity-100">
                <span className="text-[#ffff00] text-sm sm:text-base">&lt;</span>
                <span className="mx-1 sm:mx-2 text-transparent bg-clip-text bg-gradient-to-r from-[#ffff00] via-[#00F5FF] to-[#8A2BE2]">
                  {displayText}
                </span>
              ...
              <p className="body-text text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-4 opacity-100">
                {portfolioData.hero.tagline}
              </p>

              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4 sm:px-0 opacity-100">
                <Link
                  to="projects"
                  smooth={true}
                  duration={500}
              ...
              <div className="flex justify-center items-center space-x-6 sm:space-x-8 mt-8 sm:mt-12 opacity-100">
                {Object.entries(portfolioData.hero.social).map(([platform, url]) => (
                  ...
                  >
                    ...
                    {/* Underline effect */}
                    <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-[#ffff00] to-[#00F5FF] transition-all duration-300 group-hover:w-8"></span>
                  </a>
                ))}
              </div>
            </div>
