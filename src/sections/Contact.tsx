          ...
          <div className={`reveal reveal-fade-in-up reveal-stagger-1 ${isVisible ? 'reveal-active' : ''}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="group relative">
                ...
                <Card className="relative hover:transform hover:-translate-y-1 transition-transform duration-300 hover:border-[#ffff00]/30 backdrop-blur-xl bg-white/[0.03] border-white/10 shadow-[0_0_40px_rgba(212,175,55,0.15)]">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    <div className="w-14 h-14 bg-gradient-to-br from-gold-luster/20 to-sapphire-blue/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 border border-gold-luster/30 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                      <svg className="w-7 h-7 text-[#ffff00]" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="group relative">
                ...
                <Card className="relative hover:transform hover:-translate-y-1 transition-transform duration-300 hover:border-[#ffff00]/30 backdrop-blur-xl bg-white/[0.03] border-white/10 shadow-[0_0_40px_rgba(212,175,55,0.15)]">
                  <CardContent className="p-6 flex flex-col items-center text-center">
                    <div className="w-14 h-14 bg-gradient-to-br from-gold-luster/20 to-sapphire-blue/20 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 border border-gold-luster/30 shadow-[0_0_20px_rgba(212,175,55,0.2)]">
                      <svg className="w-7 h-7 text-[#ffff00]" fill="currentColor" viewBox="0 0 24 24">
