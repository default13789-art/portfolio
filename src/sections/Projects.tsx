  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="glow-orb w-96 h-96 bg-[#00F5FF]/20 top-20 -left-48"></div>
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <TiltCard
                ...
                glowColor={index % 2 === 0 ? '#00F5FF' : '#8A2BE2'}
                ...
                <CardContent className="card-content flex flex-col h-full">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {project.tech.map((tech, techIndex) => (
                      <span
                        key={techIndex}
                        className="tech-tag inline-flex items-center gap-1 px-2.5 py-0.5 bg-[#050510] text-sapphire-blue text-xs font-mono rounded-md border border-sapphire-blue/15 hover:border-sapphire-blue/35 hover:bg-sapphire-blue/5 cursor-default transition-all"
                      >
